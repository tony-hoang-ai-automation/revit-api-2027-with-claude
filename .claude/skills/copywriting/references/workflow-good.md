...
1. **Screenshots provided** → Use `bs:ai-multimodal` skill for detailed context analysis
2. **Videos provided** → Use `bs:ai-multimodal` video-analysis for comprehensive context
