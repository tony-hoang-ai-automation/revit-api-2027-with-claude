...
Handled by **bs:cook** skill. Bootstrap-specific notes:
...
- Asset pipeline: `bs:ai-multimodal` (generate/analyze) → `imagemagick` (crop/resize) → background removal if needed
