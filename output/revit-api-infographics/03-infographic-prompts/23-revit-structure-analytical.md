# Prompt Infographic: Revit Structure: Structural Elements và Analytical Model

## Output đã render
`../04-infographics-png/23-revit-structure-analytical.png`
...
Primary request:
Create a polished vertical technical infographic titled "Revit Structure: Structural Elements và Analytical Model". The poster must explain the topic clearly for a developer who knows C# but is learning Revit API. The visual should feel like a premium developer documentation poster, not a marketing landing page.

Audience:
Vietnamese BIM developers, Revit API add-in developers, C# engineers working with Autodesk Revit.

Subject:
Revit API learning poster about "Revit Structure: Structural Elements và Analytical Model".
