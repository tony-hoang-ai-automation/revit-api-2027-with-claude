...
### Step 2: Summarize the plans and document them with `/bs:journal` skill invocation
...
- Stage and commit the changes (Use `/bs:git` for commit flow)
- Commit and push the changes (Use `/bs:git` for push flow)
