...
**Typically precedes:** `/bs:debug` (debug after scouting), `/bs:fix` (fix after locating code), `/bs:code-review` (scout edge cases before review)
**Related:** `/bs:debug` (investigate after scouting), `/bs:brainstorm` (explore after scouting)
