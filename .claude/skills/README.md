...
Skills are simple to create - just a folder with a `SKILL.md` file containing YAML frontmatter and instructions. Use the `/bs:skill-creator` skill to scaffold a new one, or copy any existing skill (e.g., `show-off/`) as a starting point:
