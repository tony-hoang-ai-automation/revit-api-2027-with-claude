...
3. If no logo provided: generate with `bs:ai-multimodal` skill
4. Screenshot wireframes with `bs:agent-browser` → save to `./docs/wireframes/`
...
Activate **bs:plan** skill: `/bs:plan --auto <requirements>`
...
Activate **bs:cook** skill: `/bs:cook --auto <plan-path>`
