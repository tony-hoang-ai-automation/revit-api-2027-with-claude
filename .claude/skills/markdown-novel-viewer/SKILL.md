...
**Note:** HTML generation mode (`/bs:preview --html ...`) produces self-contained HTML files that open directly in the browser — they do not use this server.
...
Use `/bs:preview` for quick access:

```bash
/bs:preview plans/my-plan/plan.md    # View markdown file
/bs:preview plans/                   # Browse directory
/bs:preview --stop                   # Stop server
```
