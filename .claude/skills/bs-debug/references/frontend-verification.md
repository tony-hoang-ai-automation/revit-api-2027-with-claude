...
Visual verification of frontend implementations using Chrome MCP / `chrome-devtools-mcp`, `bs:agent-browser`, or project-native browser tests.
...
- Visual chebs: [pass | issues found]
