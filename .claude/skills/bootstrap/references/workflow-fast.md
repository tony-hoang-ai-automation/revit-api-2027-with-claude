...
2. If no logo provided: generate with `bs:ai-multimodal` skill
3. Screenshot wireframes with `bs:agent-browser` → save to `./docs/wireframes/`
...
Activate **bs:plan** skill: `/bs:plan --fast <requirements>`
...
Activate **bs:cook** skill: `/bs:cook <plan-path>`
