...
Use `bs:agent-browser` for live browser interaction and `bs:web-testing` or project-native Playwright/Vitest/k6 commands for repeatable test runs.
...
## Workflow
- Use `bs:plan` skill to organize the test plan & report
...
- Use `bs:ai-multimodal` to analyze all screenshots
- Generate comprehensive Markdown report
- Ask user if they want to preview with `/bs:preview`
