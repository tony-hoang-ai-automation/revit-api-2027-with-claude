...
```
/bs:security-scan              # Full scan of current project
/bs:security-scan --secrets-only   # Only secret/credential detection
/bs:security-scan --deps-only      # Only dependency audit
/bs:security-scan src/api/         # Scan specific directory
```
