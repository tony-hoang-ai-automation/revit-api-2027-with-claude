...
- **Sync-babs:** Update `[ ]` → `[x]` in phase files, update plan.md frontmatter status
...
1. User runs `/bs:cook path/to/plan.md` in new session
...
2. `project-manager` subagent runs full-plan sync-babs:
