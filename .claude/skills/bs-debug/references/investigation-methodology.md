...
- Otherwise use `bs:repomix` to generate fresh codebase summary
- Use `/bs:scout` or `/bs:scout ext` to find relevant files
- Use `bs:docs-seeker` skill for package/plugin documentation
